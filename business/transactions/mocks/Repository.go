...
func (_m *Repository) GetAllUserTrans(userID int) ([]transactions.Domain, error) {
...
func (_m *Repository) Trans(userID int, domain *transactions.Domain) (transactions.Domain, error) {
